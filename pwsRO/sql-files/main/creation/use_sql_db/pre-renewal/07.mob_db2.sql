...
#REPLACE INTO `mob_db2` (`id`,`name_aegis`,`name_english`,`name_japanese`,`level`,`hp`,`base_exp`,`job_exp`,`attack`,`attack2`,`defense`,`magic_defense`,`str`,`agi`,`vit`,`int`,`dex`,`luk`,`attack_range`,`skill_range`,`chase_range`,`size`,`race`,`element`,`element_level`,`walk_speed`,`attack_delay`,`attack_motion`,`damage_motion`,`ai`,`drop1_item`,`drop1_rate`,`drop2_item`,`drop2_rate`,`drop3_item`,`drop3_rate`,`drop4_item`,`drop4_rate`) VALUES (1844,'G_ISIS_','Snake Lord\'s Minon','蛇女伊絲',47,7003,3709,1550,423,507,10,35,38,65,43,50,66,15,1,10,12,'Large','Demon','Dark',1,200,1384,768,336,'09','Copper_Coin_',1000,'Silver_Coin_',100,'Gold_Coin_US',30,'Black_Treasure_Box',8);
